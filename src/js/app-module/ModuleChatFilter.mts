...
class ModuleChatFilter extends ModuleBase {
    ...
    onMessageTransform(ctx: CBcontext) {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        ...
        const words: string[] = message.orig.match(wordRegex) as string[];
        ...
        function compareWord(
            word: string, badWord: string, 
            collator: Intl.Collator, fuzzyScoreMin: number
            ) {
